...
// Cyprus Police Registration System - EU Best Practice & Future-Ready
// Currently configured for voluntary guest data management
// Ready for immediate activation when/if Cyprus implements mandatory requirements
