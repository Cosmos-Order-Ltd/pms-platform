/**
 * Cyprus Access Control (CAC) - Admin Dashboard Routes
 * Protected admin interface with live tracking and analytics
 */
...
/**
 * Live Admin Dashboard with Real-time Map
 * GET /api/dashboard
 */
...
/**
 * Create new invitation from admin interface
...
/**
 * Get geofencing management interface
 * GET /api/geofencing
 */
router.get('/geofencing', async (req: Request, res: Response) => {
  try {
    res.json({
      success: true,
...
function generateInvitationNumber(businessType: string): string {
